	    ...
	    */
	    for (int i = 0; i < numArticulos; i++)
	    {
	        ...
	        for (int j = 0; j < numBodegas; j++)
	        {
	            ...
	            // {
	            //     bool agregado;
	            //     string *ptrArticulo = &misArticulos[i];
	            //     agregado = misBodegas[j].AgregarArticulo(ptrArticulo);
	            //     if (agregado)
	            //     {
	            ...
	            //     else
	            //     {
	            //         cout << "El articulo ya esta en la bodega." << endl;
	            //     }
	            // }
	            if (agregar)
	            {
	                string *articulo = &misArticulos[i];
	                AgregarArticuloABodega(articulo, misBodegas[j]);
	            }
	        }
	    }
